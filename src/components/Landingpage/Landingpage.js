			...
			<div className="Landingpage">
				<div className="row">
					<div className="col-12 mb-3 p-0">
						...
						<div>
							Ich darf euch recht herzlich auf meiner kleinen
							Seite begrüßen euch erwarten alte und neue Games im
							Stream oder als Let's Play. Seit April 2016 lasse
							ich meinem Hobby auf
						</div>
					</div>
					<div className="col-12 mb-3 p-0">
					...
					<div className="col-12 mb-3 p-0">
						<div>
							freien lauf, da ich dies aber nur aus Spaß an der
							Freude betreib habt bitte Verständnis dafür, dass
							ich nicht jeden Tag irgendwelchen Kram raus hau.
						</div>
						<div>
							Ich zocke auch nur Spiele die mich selbst
							interessieren. Spielempfehlungen oder Vorführungen
							folgen ggf. zu einem späteren Zeitpunkt. ;-)
						</div>
						<div>
							Ich bin für jeden Support dankbar. Denn auch ein
							Daumen hoch, ein Kommentar, ein Teilen, ein
							Weiterempfehlen ist für mich von riesiger Bedeutung
							und unterstützt mich auch. Solltet ihr dies
							allerdings anders zeigen wollen, könnt ihr das auch
							gerne via{' '}
							<Link
